...
INSERT IGNORE INTO `roles` (`role_name`,`created_at`, `created_by`)
...
DELETE FROM person where email='lecturer@eazyschool.com';
DELETE FROM person where email='student@eazyschool.com';
...
INSERT INTO `person` (`name`,`email`,`mobile_number`,`pwd`,`role_id`,`created_at`, `created_by`)
  VALUES ('Lecturer Test','lecturer@eazyschool.com','1234567890','$2a$10$XhU4UcSxDPb5G0I0fT/CZ.Lfj2VW2fkLkUP5cOEM.xM8EzyUQXaD2', 3 ,CURDATE(),'DBA');

INSERT INTO `person` (`name`,`email`,`mobile_number`,`pwd`,`role_id`,`created_at`, `created_by`)
  VALUES ('Student Test','student@eazyschool.com','0987654321','$2a$10$XhU4UcSxDPb5G0I0fT/CZ.Lfj2VW2fkLkUP5cOEM.xM8EzyUQXaD2', 2 ,CURDATE(),'DBA');

INSERT IGNORE INTO `courses` (`name`,`fees`,`description`,`num_lessons`,`created_at`, `created_by`)
  VALUES ('Introduction to Programming','150','Learn the fundamentals of programming with hands-on exercises. Perfect for beginners who want to start their coding journey.',12,CURDATE(),'DBA');

INSERT IGNORE INTO `courses` (`name`,`fees`,`description`,`num_lessons`,`created_at`, `created_by`)
  VALUES ('Web Development Basics','200','Master HTML, CSS and JavaScript. Build responsive websites from scratch and learn modern web development practices.',18,CURDATE(),'DBA');

INSERT IGNORE INTO `courses` (`name`,`fees`,`description`,`num_lessons`,`created_at`, `created_by`)
  VALUES ('Database Management','180','Understand relational databases, SQL queries, and database design principles. Hands-on experience with MySQL.',15,CURDATE(),'DBA');

INSERT IGNORE INTO `courses` (`name`,`fees`,`description`,`num_lessons`,`created_at`, `created_by`)
  VALUES ('Java Programming','250','Comprehensive Java course covering OOP, collections, streams, and enterprise development with Spring Boot.',24,CURDATE(),'DBA');

INSERT IGNORE INTO `contact_msg` (`name`,`mobile_num`,`email`,`subject`,`message`,`status`,`created_at`, `created_by`)
